...
import { Flame, Moon, Zap, Scroll, Check, AlertTriangle } from "lucide-react";
  ...
  return (
    <div className="upsell-container">
      ...
      <section className="hero">
        <div className="wrap">
          <div className="eyebrow">AȘTEAPTĂ! ÎNAINTE SĂ CONTINUI...</div>
          <h1 className="display">Există un Ritual Făcut<br /><em>Special Pentru Zodia Ta</em></h1>
          <p className="sub sans">Ritualurile de Protecție pe care tocmai le-ai luat sunt universale. Dar tradiția spune că fiecare zodie are o «poartă» proprie — un ritual principal, unul lunar, și unul de urgență, croite exact pe firea ta.</p>
      ...
      <section>
        <div className="wrap">
          ...
          <p className="section-sub sans">Diferența dintre ce ai deja și ediția extinsă, zodie cu zodie.</p>
          <div className="compare">
            <div className="compare-col standard">
              <div className="compare-label sans">CE AI DEJA</div>
              <ul>
                <li>· Ritualuri generale, pentru orice persoană</li>
                <li>· Un sistem, aplicabil pentru toată lumea</li>
              </ul>
            </div>
            <div className="compare-col extins">
              <div className="compare-label sans">EDIȚIA ZODIACALĂ</div>
              <ul>
                <li>· Ritual principal pentru zodia ta</li>
                <li>· Ritual lunar de recalibrare</li>
                <li>· Ritual de urgență, pentru momente acute</li>
                <li>· Talisman, piatră, zi și culoare norocoasă</li>
                <li>· O poveste tradițională pentru zodia ta</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <section className="offer" style={{ background: "var(--bg-panel)" }}>
        <div className="wrap" style={{ textAlign: "left" }}>
          <h2 className="section-title">Ce găsești pentru <span className="accent">zodia ta</span></h2>
          <div className="inside-grid">
            <div className="inside-card">
              <Flame className="w-6 h-6 text-[var(--gold)] mb-2" />
              <h3>Ritualul Principal</h3>
              <p className="sans">Complet, cu tot ce ai nevoie — materiale, moment, formulă.</p>
            </div>
            <div className="inside-card">
              <Moon className="w-6 h-6 text-[var(--gold)] mb-2" />
              <h3>Ritualul Lunar</h3>
              <p className="sans">De repetat o dată pe lună, pentru echilibru pe termen lung.</p>
            </div>
            <div className="inside-card">
              <Zap className="w-6 h-6 text-[var(--gold)] mb-2" />
              <h3>Ritualul de Urgență</h3>
              <p className="sans">Pentru momentele acute, când nu ai timp de tot restul.</p>
            </div>
            <div className="inside-card">
              <Scroll className="w-6 h-6 text-[var(--gold)] mb-2" />
              <h3>Poveste Tradițională</h3>
              <p className="sans">O legendă populară legată de firea zodiei tale.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section>
        <div className="wrap">
          <div className="testimonial">
            ...
            <p className="sans">"Am făcut ritualul deschiderii drumurilor chiar înainte de interviu. A doua zi am primit oferta. Îl fac înainte de orice decizie mare acum."</p>
      ...
      <section className="offer" id="oferta">
        <div className="wrap">
          <div className="scarcity sans flex items-center justify-center gap-1.5 mx-auto w-fit">
            ...
            <span>Ofertă disponibilă doar acum, o singură dată</span>
          </div>
          <h2 className="section-title">Ediția Extinsă, la preț de <span className="accent">lansare</span></h2>
